...
GROUPS = [
  ...
  (("Docker", "x86_64"), [15.394, 25.079, 39.050, 22.066, 28.070]),
  (("Docker", "x86"), [25.789, 253.702, 323.398, 324.264, 222.623]),
  (("Docker", "aarch64"), [0.330, 4.466, 27.203, 27.275, 20.222]),
  (("Docker", "riscv64"), [59.584, 215.296, 271.262, 271.241, 185.151]),
  (("AWS t3 Nitro", "x86_64"), [8.711, 13.254, 9.356, 9.356, 24.249]),
  (("AWS m7i metal", "x86_64"), [6.841, 7.130, 6.841, 6.841, 14.734]),
  (("AWS t3 Nitro", "x86"), [13.552, 69.312, 14.363, 14.154, 66.458]),
  (("AWS m7i metal", "x86"), [6.841, 23.066, 6.841, 6.841, 22.743]),
  (("AWS Windows", "c5.large", "x86_64"), [8.417, 14.367, 34.247, 34.286, 41.391]),
]
